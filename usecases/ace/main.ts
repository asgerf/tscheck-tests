...
// 	var rl = new ace.Range(1,1, 2,2) // No static type error, but runtime error: "Uncaught TypeError: undefined is not a function"
// })

// ------------ FIXED in ace.2.d.ts (deleted constructors that just aren't there; they appear to be for internal use only, but for reason is documented in the API)
